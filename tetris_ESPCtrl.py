...
# --- WEBSOCKET SERVER ---
# Deze server luistert naar inkomende berichten van de ESP32 en voegt ze toe aan de remote_commands lijst.
...
def main():
    ...
    while running:
        ...
        if handle_remote_commands(current_piece, grid, game_over) == "RESTART":
            main()
            return
